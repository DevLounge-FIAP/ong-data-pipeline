def schemas_silver():
    ...
    BIGQUERY_SCHEMAS_SILVER: dict[str, list[dict[str, str]]] = {
        "silver_entradas": [
            ...
            {"name": "data_de_entrada", "type": "DATE", "mode": "REQUIRED"},
            {"name": "nome_do_responsavel", "type": "STRING", "mode": "NULLABLE"},
            {"name": "sobrenome_do_responsavel", "type": "STRING", "mode": "NULLABLE"},
            {"name": "nome_animal", "type": "STRING", "mode": "NULLABLE"},
            {"name": "especie_do_animal", "type": "STRING", "mode": "NULLABLE"},
            {"name": "sexo", "type": "STRING", "mode": "NULLABLE"},
            {"name": "porte", "type": "STRING", "mode": "NULLABLE"},
            {"name": "condicao_de_saude", "type": "STRING", "mode": "NULLABLE"},
            {"name": "status_atual", "type": "STRING", "mode": "NULLABLE"},
            {"name": "historico_observacoes", "type": "STRING", "mode": "NULLABLE"},
        ...
        "silver_prontuarios": [
            ...
            {"name": "id_animal", "type": "STRING", "mode": "REQUIRED"},
            {"name": "carimbo_ts", "type": "TIMESTAMP", "mode": "REQUIRED"},
            {"name": "data_do_procedimento", "type": "DATE", "mode": "REQUIRED"},
            {"name": "nome_do_profissional", "type": "STRING", "mode": "NULLABLE"},
            {"name": "tipo_de_evento", "type": "STRING", "mode": "NULLABLE"},
            {"name": "categoria_medicamento", "type": "STRING", "mode": "NULLABLE"},
            {"name": "nome_medicamento", "type": "STRING", "mode": "NULLABLE"},
            {"name": "categoria_vacina", "type": "STRING", "mode": "NULLABLE"},
            {"name": "nome_vacina", "type": "STRING", "mode": "NULLABLE"},
            {"name": "nome_cirurgia_realizada", "type": "STRING", "mode": "NULLABLE"},
        ...
        "silver_saidas": [
            ...
            {"name": "id_animal", "type": "STRING", "mode": "REQUIRED"},
            {"name": "carimbo_ts", "type": "TIMESTAMP", "mode": "REQUIRED"},
            {"name": "data_da_saida", "type": "DATE", "mode": "REQUIRED"},
            {"name": "motivo_da_saida", "type": "STRING", "mode": "NULLABLE"},
            {"name": "nome_do_adotante_tutor", "type": "STRING", "mode": "NULLABLE"},
            {"name": "telefone_de_contato", "type": "STRING", "mode": "NULLABLE"},
            {"name": "cidade_de_destino", "type": "STRING", "mode": "NULLABLE"},
            {"name": "bairro_de_destino", "type": "STRING", "mode": "NULLABLE"},
            {"name": "numero_do_imovel", "type": "INTEGER", "mode": "NULLABLE"},
            {"name": "tipo_do_imovel", "type": "STRING", "mode": "NULLABLE"},
